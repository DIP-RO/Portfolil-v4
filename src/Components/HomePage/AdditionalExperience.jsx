...
import { AdditionalExperienceData } from '@/Constants/Constants';
...
const AdditionalExperience = () => {
    const experienceChunks = chunkArray(AdditionalExperienceData, 3);

    return (
        <div id="experience" className="px-6 lg:px-32 py-20">
            <h2 className="head-text">Additional Experience</h2>
